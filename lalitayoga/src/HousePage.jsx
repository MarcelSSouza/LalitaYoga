  ...
  return (
    <div>
      ...
      />     <br></br>
        ...
        <Button variant="outline-dark" size="lg" block>Yoga Courses & Retreats</Button>
        </Container>
      <Container className="mb-5">
      <h1>The Garden</h1>
        <hr></hr>
